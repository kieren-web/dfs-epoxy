...
const faqs = [
  {
    q: "Do you install epoxy flooring in Terrigal?",
    a: "Yes. We service Terrigal and surrounding coastal suburbs regularly. We're based in Tuggerah — about 15 minutes away — and have installed in residential and commercial properties throughout the Terrigal area.",
  },
  {
    q: "Does coastal salt air affect epoxy flooring in Terrigal?",
    a: "It can if the wrong system is used. We specify UV-stable polyaspartic topcoats for all outdoor and coastal installations — systems that won't yellow, chalk, or delaminate from salt air exposure. Internal floors are generally well protected once properly coated.",
  },
  {
    q: "How much does epoxy flooring cost in Terrigal?",
    a: "Residential garage systems start from $90–$100/m². Patios and driveways vary based on size and condition. Commercial work is quoted on site inspection. All quotes are free, fixed-price, and provided on the day of our site visit.",
  },
  {
    q: "Can you install epoxy in a Terrigal hospitality venue?",
    a: "Yes. Cafes, restaurants, and hospitality venues in Terrigal are a good fit for our commercial kitchen and slip-resistant epoxy systems. We work around trading hours and can stage installs to minimise disruption.",
  },
];
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "Epoxy Flooring Terrigal", item: "https://dynamicflooringsolutions.com.au/epoxy-flooring-terrigal" },
  ],
};
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" style={{ background: "#1a1a1a" }}>
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-white">Epoxy Flooring Terrigal — FAQs</h2>
          </div>
